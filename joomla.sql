...
--
-- Host: localhost:8889
-- Generation Time: Mar 22, 2014 at 10:15 PM
...
--
-- Table structure for table `team_assets`
--
...
--
-- Dumping data for table `team_assets`
--

INSERT INTO `team_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Table structure for table `team_associations`
--

CREATE TABLE `team_associations` (
...
--
-- Table structure for table `team_banner_clients`
--

CREATE TABLE `team_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `team_banner_tracks`
--

CREATE TABLE `team_banner_tracks` (
...
INSERT INTO `team_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `team_contact_details`
--

CREATE TABLE `team_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `team_contentitem_tag_map`
--

CREATE TABLE `team_contentitem_tag_map` (
...
--
-- Table structure for table `team_content_frontpage`
--

CREATE TABLE `team_content_frontpage` (
...
--
-- Table structure for table `team_content_rating`
--

CREATE TABLE `team_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `team_content_types`
--
...
--
-- Dumping data for table `team_content_types`
--

INSERT INTO `team_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `team_core_log_searches`
--

CREATE TABLE `team_core_log_searches` (
...
--
-- Table structure for table `team_extensions`
--
...
--
-- Dumping data for table `team_extensions`
--

INSERT INTO `team_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"f05c34cf965d8518464e8c70a500d6ae"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Table structure for table `team_finder_filters`
--

CREATE TABLE `team_finder_filters` (
...
--
-- Table structure for table `team_finder_links`
--

CREATE TABLE `team_finder_links` (
...
--
-- Table structure for table `team_finder_links_terms0`
--

CREATE TABLE `team_finder_links_terms0` (
...
--
-- Table structure for table `team_finder_links_terms1`
--

CREATE TABLE `team_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms2`
--

CREATE TABLE `team_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms3`
--

CREATE TABLE `team_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms4`
--

CREATE TABLE `team_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms5`
--

CREATE TABLE `team_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms6`
--

CREATE TABLE `team_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms7`
--

CREATE TABLE `team_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms8`
--

CREATE TABLE `team_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_terms9`
--

CREATE TABLE `team_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_termsa`
--

CREATE TABLE `team_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_termsb`
--

CREATE TABLE `team_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_termsc`
--

CREATE TABLE `team_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_termsd`
--

CREATE TABLE `team_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_termse`
--

CREATE TABLE `team_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_links_termsf`
--

CREATE TABLE `team_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `team_finder_taxonomy`
--

CREATE TABLE `team_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `team_finder_taxonomy`
--

INSERT INTO `team_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `team_finder_taxonomy_map`
--

CREATE TABLE `team_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `team_finder_terms`
--

CREATE TABLE `team_finder_terms` (
...
--
-- Table structure for table `team_finder_terms_common`
--

CREATE TABLE `team_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `team_finder_terms_common`
--

INSERT INTO `team_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `team_finder_tokens`
--

CREATE TABLE `team_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `team_finder_tokens_aggregate`
--

CREATE TABLE `team_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `team_finder_types`
--

CREATE TABLE `team_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `team_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
INSERT INTO `team_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Table structure for table `team_menu_types`
--

CREATE TABLE `team_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `team_menu_types`
--

INSERT INTO `team_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
--
-- Table structure for table `team_messages_cfg`
--

CREATE TABLE `team_messages_cfg` (
...
--
-- Table structure for table `team_modules`
--
...
--
-- Dumping data for table `team_modules`
--

INSERT INTO `team_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `team_modules_menu`
--

CREATE TABLE `team_modules_menu` (
...
--
-- Dumping data for table `team_modules_menu`
--

INSERT INTO `team_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `team_newsfeeds`
--

CREATE TABLE `team_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `team_overrider`
--

CREATE TABLE `team_overrider` (
...
--
-- Table structure for table `team_postinstall_messages`
--

CREATE TABLE `team_postinstall_messages` (
...
--
-- Dumping data for table `team_postinstall_messages`
--

INSERT INTO `team_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `team_redirect_links`
--

CREATE TABLE `team_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `team_schemas`
--
...
--
-- Dumping data for table `team_schemas`
--

INSERT INTO `team_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.2.3-2014-02-20');

-- --------------------------------------------------------

--
-- Table structure for table `team_session`
--
...
--
-- Dumping data for table `team_session`
--

INSERT INTO `team_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('dad20c692ece62ae8478e9f5d2555a7e', 1, 1, '1395514054', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1395514054;s:18:"session.timer.last";i:1395514054;s:17:"session.timer.now";i:1395514054;s:22:"session.client.browser";s:117:"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_2) AppleWebKit/537.74.9 (KHTML, like Gecko) Version/7.0.2 Safari/537.74.9";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";N;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";N;s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"7a06a8c9e6902858d419a2871892eee6";}', 0, '');
...
INSERT INTO `team_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `team_template_styles`
--

CREATE TABLE `team_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `team_template_styles`
--

INSERT INTO `team_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `team_ucm_base`
--

CREATE TABLE `team_ucm_base` (
...
--
-- Table structure for table `team_ucm_content`
--

CREATE TABLE `team_ucm_content` (
...
--
-- Table structure for table `team_ucm_history`
--

CREATE TABLE `team_ucm_history` (
...
--
-- Table structure for table `team_update_sites`
--

CREATE TABLE `team_update_sites` (
...
--
-- Dumping data for table `team_update_sites`
--

INSERT INTO `team_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
...
--
-- Table structure for table `team_update_sites_extensions`
--

CREATE TABLE `team_update_sites_extensions` (
...
--
-- Dumping data for table `team_update_sites_extensions`
--

INSERT INTO `team_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Table structure for table `team_usergroups`
--

CREATE TABLE `team_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `team_usergroups`
--

INSERT INTO `team_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
INSERT INTO `team_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`) VALUES
(997, 'Super User', 'jschavey', 'jschavey@me.com', '$P$DMr.CK7uAs7k/fkMRcG5UmJo4Cyfvm/', 0, 1, '2014-03-22 18:44:21', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `team_user_keys`
--

CREATE TABLE `team_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `team_user_notes`
--

CREATE TABLE `team_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `team_user_profiles`
--

CREATE TABLE `team_user_profiles` (
...
--
-- Table structure for table `team_user_usergroup_map`
--

CREATE TABLE `team_user_usergroup_map` (
...
--
-- Dumping data for table `team_user_usergroup_map`
--

INSERT INTO `team_user_usergroup_map` (`user_id`, `group_id`) VALUES
(997, 8);

-- --------------------------------------------------------

--
-- Table structure for table `team_viewlevels`
--

CREATE TABLE `team_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `team_viewlevels`
--

INSERT INTO `team_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `team_weblinks`
--

CREATE TABLE `team_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
